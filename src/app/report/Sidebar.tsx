      ...
      <div>
        ...
        <nav className="mt-4">
          ...
          <li className="cursor-pointer hover:text-blue-700">Visión general</li>
            ...
            <li className="cursor-pointer hover:text-blue-700">Generación de leads y ROI</li>
            <li className="cursor-pointer hover:text-blue-700">Compromiso con el cliente</li>
