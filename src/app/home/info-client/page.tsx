    ...
    return (
        <>
            ...
            <section className="flex flex-auto">
                        ...
                        <section className="flex flex-col gap-5 border-b-2 py-5">
                            <div className="flex gap-3 items-center">
                                ...
                                <span className="flex gap-3">
                                    <Chip label="Lead" className="bg-[#129cffff] text-white rounded-3xl px-3 py-1" />
                                    <Chip label="Lead" className="bg-[#129cffff] text-white rounded-3xl px-3 py-1" />
                                    <Chip label="Lead" className="bg-[#129cffff] text-white rounded-3xl px-3 py-1" />
                                </span>
                            </div>
                ...
                <main className="flex ">
                    <TabView activeIndex={activeIndex} onTabChange={(e) => setActiveIndex(e.index)} className="flex flex-col">
