      ...
      <div>
        ...
        <nav className="mt-4">
          <ul className="flex flex-col space-y-4 px-6 text-gray-800">
            <Link href="/home/dashboard" className="cursor-pointer hover:text-blue-700">Visión general</Link>
            <Link href="" className="cursor-pointer hover:text-blue-700">Apoyo al cliente</Link>
            <Link href="" className="cursor-pointer hover:text-blue-700">Productividad</Link>
          </ul>
        </nav>
